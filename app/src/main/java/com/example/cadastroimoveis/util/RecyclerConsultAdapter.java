...
public class RecyclerConsultAdapter extends RecyclerView.Adapter<RecyclerConsultAdapter.ViewHolder> {
    ...
    public RecyclerConsultAdapter(ArrayList<Casa> casas, Context context) {
        this.casas = casas;
